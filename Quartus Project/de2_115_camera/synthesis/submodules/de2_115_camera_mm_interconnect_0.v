// de2_115_camera_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module de2_115_camera_mm_interconnect_0 (
		...
		output wire [0:0]  lcd_0_avalon_lcd_slave_address,                 //                   lcd_0_avalon_lcd_slave.address
		output wire        lcd_0_avalon_lcd_slave_write,                   //                                         .write
		output wire        lcd_0_avalon_lcd_slave_read,                    //                                         .read
		input  wire [7:0]  lcd_0_avalon_lcd_slave_readdata,                //                                         .readdata
		output wire [7:0]  lcd_0_avalon_lcd_slave_writedata,               //                                         .writedata
		input  wire        lcd_0_avalon_lcd_slave_waitrequest,             //                                         .waitrequest
		output wire        lcd_0_avalon_lcd_slave_chipselect,              //                                         .chipselect
		...
		output wire [1:0]  pixel_s1_address,                               //                                 pixel_s1.address
		input  wire [31:0] pixel_s1_readdata,                              //                                         .readdata
	...
	wire   [7:0] lcd_0_avalon_lcd_slave_agent_m0_readdata;                                           // lcd_0_avalon_lcd_slave_translator:uav_readdata -> lcd_0_avalon_lcd_slave_agent:m0_readdata
	wire         lcd_0_avalon_lcd_slave_agent_m0_waitrequest;                                        // lcd_0_avalon_lcd_slave_translator:uav_waitrequest -> lcd_0_avalon_lcd_slave_agent:m0_waitrequest
	wire         lcd_0_avalon_lcd_slave_agent_m0_debugaccess;                                        // lcd_0_avalon_lcd_slave_agent:m0_debugaccess -> lcd_0_avalon_lcd_slave_translator:uav_debugaccess
	wire  [20:0] lcd_0_avalon_lcd_slave_agent_m0_address;                                            // lcd_0_avalon_lcd_slave_agent:m0_address -> lcd_0_avalon_lcd_slave_translator:uav_address
	wire   [0:0] lcd_0_avalon_lcd_slave_agent_m0_byteenable;                                         // lcd_0_avalon_lcd_slave_agent:m0_byteenable -> lcd_0_avalon_lcd_slave_translator:uav_byteenable
	wire         lcd_0_avalon_lcd_slave_agent_m0_read;                                               // lcd_0_avalon_lcd_slave_agent:m0_read -> lcd_0_avalon_lcd_slave_translator:uav_read
	wire         lcd_0_avalon_lcd_slave_agent_m0_readdatavalid;                                      // lcd_0_avalon_lcd_slave_translator:uav_readdatavalid -> lcd_0_avalon_lcd_slave_agent:m0_readdatavalid
	wire         lcd_0_avalon_lcd_slave_agent_m0_lock;                                               // lcd_0_avalon_lcd_slave_agent:m0_lock -> lcd_0_avalon_lcd_slave_translator:uav_lock
	wire   [7:0] lcd_0_avalon_lcd_slave_agent_m0_writedata;                                          // lcd_0_avalon_lcd_slave_agent:m0_writedata -> lcd_0_avalon_lcd_slave_translator:uav_writedata
	wire         lcd_0_avalon_lcd_slave_agent_m0_write;                                              // lcd_0_avalon_lcd_slave_agent:m0_write -> lcd_0_avalon_lcd_slave_translator:uav_write
	wire   [0:0] lcd_0_avalon_lcd_slave_agent_m0_burstcount;                                         // lcd_0_avalon_lcd_slave_agent:m0_burstcount -> lcd_0_avalon_lcd_slave_translator:uav_burstcount
	wire         lcd_0_avalon_lcd_slave_agent_rf_source_valid;                                       // lcd_0_avalon_lcd_slave_agent:rf_source_valid -> lcd_0_avalon_lcd_slave_agent_rsp_fifo:in_valid
	wire  [70:0] lcd_0_avalon_lcd_slave_agent_rf_source_data;                                        // lcd_0_avalon_lcd_slave_agent:rf_source_data -> lcd_0_avalon_lcd_slave_agent_rsp_fifo:in_data
	wire         lcd_0_avalon_lcd_slave_agent_rf_source_ready;                                       // lcd_0_avalon_lcd_slave_agent_rsp_fifo:in_ready -> lcd_0_avalon_lcd_slave_agent:rf_source_ready
	wire         lcd_0_avalon_lcd_slave_agent_rf_source_startofpacket;                               // lcd_0_avalon_lcd_slave_agent:rf_source_startofpacket -> lcd_0_avalon_lcd_slave_agent_rsp_fifo:in_startofpacket
	wire         lcd_0_avalon_lcd_slave_agent_rf_source_endofpacket;                                 // lcd_0_avalon_lcd_slave_agent:rf_source_endofpacket -> lcd_0_avalon_lcd_slave_agent_rsp_fifo:in_endofpacket
	wire         lcd_0_avalon_lcd_slave_agent_rsp_fifo_out_valid;                                    // lcd_0_avalon_lcd_slave_agent_rsp_fifo:out_valid -> lcd_0_avalon_lcd_slave_agent:rf_sink_valid
	wire  [70:0] lcd_0_avalon_lcd_slave_agent_rsp_fifo_out_data;                                     // lcd_0_avalon_lcd_slave_agent_rsp_fifo:out_data -> lcd_0_avalon_lcd_slave_agent:rf_sink_data
	wire         lcd_0_avalon_lcd_slave_agent_rsp_fifo_out_ready;                                    // lcd_0_avalon_lcd_slave_agent:rf_sink_ready -> lcd_0_avalon_lcd_slave_agent_rsp_fifo:out_ready
	wire         lcd_0_avalon_lcd_slave_agent_rsp_fifo_out_startofpacket;                            // lcd_0_avalon_lcd_slave_agent_rsp_fifo:out_startofpacket -> lcd_0_avalon_lcd_slave_agent:rf_sink_startofpacket
	wire         lcd_0_avalon_lcd_slave_agent_rsp_fifo_out_endofpacket;                              // lcd_0_avalon_lcd_slave_agent_rsp_fifo:out_endofpacket -> lcd_0_avalon_lcd_slave_agent:rf_sink_endofpacket
	...
	wire  [31:0] pixel_s1_agent_m0_readdata;                                                         // pixel_s1_translator:uav_readdata -> pixel_s1_agent:m0_readdata
	wire         pixel_s1_agent_m0_waitrequest;                                                      // pixel_s1_translator:uav_waitrequest -> pixel_s1_agent:m0_waitrequest
	wire         pixel_s1_agent_m0_debugaccess;                                                      // pixel_s1_agent:m0_debugaccess -> pixel_s1_translator:uav_debugaccess
	wire  [20:0] pixel_s1_agent_m0_address;                                                          // pixel_s1_agent:m0_address -> pixel_s1_translator:uav_address
	wire   [3:0] pixel_s1_agent_m0_byteenable;                                                       // pixel_s1_agent:m0_byteenable -> pixel_s1_translator:uav_byteenable
	wire         pixel_s1_agent_m0_read;                                                             // pixel_s1_agent:m0_read -> pixel_s1_translator:uav_read
	wire         pixel_s1_agent_m0_readdatavalid;                                                    // pixel_s1_translator:uav_readdatavalid -> pixel_s1_agent:m0_readdatavalid
	wire         pixel_s1_agent_m0_lock;                                                             // pixel_s1_agent:m0_lock -> pixel_s1_translator:uav_lock
	wire  [31:0] pixel_s1_agent_m0_writedata;                                                        // pixel_s1_agent:m0_writedata -> pixel_s1_translator:uav_writedata
	wire         pixel_s1_agent_m0_write;                                                            // pixel_s1_agent:m0_write -> pixel_s1_translator:uav_write
	wire   [2:0] pixel_s1_agent_m0_burstcount;                                                       // pixel_s1_agent:m0_burstcount -> pixel_s1_translator:uav_burstcount
	wire         pixel_s1_agent_rf_source_valid;                                                     // pixel_s1_agent:rf_source_valid -> pixel_s1_agent_rsp_fifo:in_valid
	wire  [97:0] pixel_s1_agent_rf_source_data;                                                      // pixel_s1_agent:rf_source_data -> pixel_s1_agent_rsp_fifo:in_data
	wire         pixel_s1_agent_rf_source_ready;                                                     // pixel_s1_agent_rsp_fifo:in_ready -> pixel_s1_agent:rf_source_ready
	wire         pixel_s1_agent_rf_source_startofpacket;                                             // pixel_s1_agent:rf_source_startofpacket -> pixel_s1_agent_rsp_fifo:in_startofpacket
	wire         pixel_s1_agent_rf_source_endofpacket;                                               // pixel_s1_agent:rf_source_endofpacket -> pixel_s1_agent_rsp_fifo:in_endofpacket
	wire         pixel_s1_agent_rsp_fifo_out_valid;                                                  // pixel_s1_agent_rsp_fifo:out_valid -> pixel_s1_agent:rf_sink_valid
	wire  [97:0] pixel_s1_agent_rsp_fifo_out_data;                                                   // pixel_s1_agent_rsp_fifo:out_data -> pixel_s1_agent:rf_sink_data
	wire         pixel_s1_agent_rsp_fifo_out_ready;                                                  // pixel_s1_agent:rf_sink_ready -> pixel_s1_agent_rsp_fifo:out_ready
	wire         pixel_s1_agent_rsp_fifo_out_startofpacket;                                          // pixel_s1_agent_rsp_fifo:out_startofpacket -> pixel_s1_agent:rf_sink_startofpacket
	wire         pixel_s1_agent_rsp_fifo_out_endofpacket;                                            // pixel_s1_agent_rsp_fifo:out_endofpacket -> pixel_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> pixel_s1_agent:cp_valid
	wire  [96:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> pixel_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // pixel_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> pixel_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> pixel_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> pixel_s1_agent:cp_endofpacket
	...
	wire  [20:0] read_address_s1_agent_m0_address;                                                   // read_address_s1_agent:m0_address -> read_address_s1_translator:uav_address
	...
	wire  [97:0] read_address_s1_agent_rf_source_data;                                               // read_address_s1_agent:rf_source_data -> read_address_s1_agent_rsp_fifo:in_data
	...
	wire  [97:0] read_address_s1_agent_rsp_fifo_out_data;                                            // read_address_s1_agent_rsp_fifo:out_data -> read_address_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> read_address_s1_agent:cp_valid
	wire  [96:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> read_address_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // read_address_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> read_address_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> read_address_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> read_address_s1_agent:cp_endofpacket
	...
	wire  [20:0] switch_s1_agent_m0_address;                                                         // switch_s1_agent:m0_address -> switch_s1_translator:uav_address
	...
	wire  [96:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> switch_s1_agent:cp_data
	...
	wire         lcd_0_avalon_lcd_slave_agent_rp_valid;                                              // lcd_0_avalon_lcd_slave_agent:rp_valid -> router_003:sink_valid
	wire  [69:0] lcd_0_avalon_lcd_slave_agent_rp_data;                                               // lcd_0_avalon_lcd_slave_agent:rp_data -> router_003:sink_data
	wire         lcd_0_avalon_lcd_slave_agent_rp_ready;                                              // router_003:sink_ready -> lcd_0_avalon_lcd_slave_agent:rp_ready
	wire         lcd_0_avalon_lcd_slave_agent_rp_startofpacket;                                      // lcd_0_avalon_lcd_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         lcd_0_avalon_lcd_slave_agent_rp_endofpacket;                                        // lcd_0_avalon_lcd_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire         pixel_s1_agent_rp_valid;                                                            // pixel_s1_agent:rp_valid -> router_006:sink_valid
	wire  [96:0] pixel_s1_agent_rp_data;                                                             // pixel_s1_agent:rp_data -> router_006:sink_data
	wire         pixel_s1_agent_rp_ready;                                                            // router_006:sink_ready -> pixel_s1_agent:rp_ready
	wire         pixel_s1_agent_rp_startofpacket;                                                    // pixel_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         pixel_s1_agent_rp_endofpacket;                                                      // pixel_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         read_address_s1_agent_rp_valid;                                                     // read_address_s1_agent:rp_valid -> router_007:sink_valid
	wire  [96:0] read_address_s1_agent_rp_data;                                                      // read_address_s1_agent:rp_data -> router_007:sink_data
	wire         read_address_s1_agent_rp_ready;                                                     // router_007:sink_ready -> read_address_s1_agent:rp_ready
	wire         read_address_s1_agent_rp_startofpacket;                                             // read_address_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         read_address_s1_agent_rp_endofpacket;                                               // read_address_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [96:0] switch_s1_agent_rp_data;                                                            // switch_s1_agent:rp_data -> router_008:sink_data
	...
	wire         lcd_0_avalon_lcd_slave_burst_adapter_source0_valid;                                 // lcd_0_avalon_lcd_slave_burst_adapter:source0_valid -> lcd_0_avalon_lcd_slave_agent:cp_valid
	wire  [69:0] lcd_0_avalon_lcd_slave_burst_adapter_source0_data;                                  // lcd_0_avalon_lcd_slave_burst_adapter:source0_data -> lcd_0_avalon_lcd_slave_agent:cp_data
	wire         lcd_0_avalon_lcd_slave_burst_adapter_source0_ready;                                 // lcd_0_avalon_lcd_slave_agent:cp_ready -> lcd_0_avalon_lcd_slave_burst_adapter:source0_ready
	wire   [6:0] lcd_0_avalon_lcd_slave_burst_adapter_source0_channel;                               // lcd_0_avalon_lcd_slave_burst_adapter:source0_channel -> lcd_0_avalon_lcd_slave_agent:cp_channel
	wire         lcd_0_avalon_lcd_slave_burst_adapter_source0_startofpacket;                         // lcd_0_avalon_lcd_slave_burst_adapter:source0_startofpacket -> lcd_0_avalon_lcd_slave_agent:cp_startofpacket
	wire         lcd_0_avalon_lcd_slave_burst_adapter_source0_endofpacket;                           // lcd_0_avalon_lcd_slave_burst_adapter:source0_endofpacket -> lcd_0_avalon_lcd_slave_agent:cp_endofpacket
	...
	wire         router_003_src_valid;                                                               // router_003:src_valid -> lcd_0_avalon_lcd_slave_rsp_width_adapter:in_valid
	wire  [69:0] router_003_src_data;                                                                // router_003:src_data -> lcd_0_avalon_lcd_slave_rsp_width_adapter:in_data
	wire         router_003_src_ready;                                                               // lcd_0_avalon_lcd_slave_rsp_width_adapter:in_ready -> router_003:src_ready
	wire   [6:0] router_003_src_channel;                                                             // router_003:src_channel -> lcd_0_avalon_lcd_slave_rsp_width_adapter:in_channel
	wire         router_003_src_startofpacket;                                                       // router_003:src_startofpacket -> lcd_0_avalon_lcd_slave_rsp_width_adapter:in_startofpacket
	wire         router_003_src_endofpacket;                                                         // router_003:src_endofpacket -> lcd_0_avalon_lcd_slave_rsp_width_adapter:in_endofpacket
	wire         lcd_0_avalon_lcd_slave_rsp_width_adapter_src_valid;                                 // lcd_0_avalon_lcd_slave_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [96:0] lcd_0_avalon_lcd_slave_rsp_width_adapter_src_data;                                  // lcd_0_avalon_lcd_slave_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire         lcd_0_avalon_lcd_slave_rsp_width_adapter_src_ready;                                 // rsp_demux_001:sink_ready -> lcd_0_avalon_lcd_slave_rsp_width_adapter:out_ready
	wire   [6:0] lcd_0_avalon_lcd_slave_rsp_width_adapter_src_channel;                               // lcd_0_avalon_lcd_slave_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire         lcd_0_avalon_lcd_slave_rsp_width_adapter_src_startofpacket;                         // lcd_0_avalon_lcd_slave_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire         lcd_0_avalon_lcd_slave_rsp_width_adapter_src_endofpacket;                           // lcd_0_avalon_lcd_slave_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	wire         cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> lcd_0_avalon_lcd_slave_cmd_width_adapter:in_valid
	wire  [96:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> lcd_0_avalon_lcd_slave_cmd_width_adapter:in_data
	wire         cmd_mux_001_src_ready;                                                              // lcd_0_avalon_lcd_slave_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire   [6:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> lcd_0_avalon_lcd_slave_cmd_width_adapter:in_channel
	wire         cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> lcd_0_avalon_lcd_slave_cmd_width_adapter:in_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> lcd_0_avalon_lcd_slave_cmd_width_adapter:in_endofpacket
	wire         lcd_0_avalon_lcd_slave_cmd_width_adapter_src_valid;                                 // lcd_0_avalon_lcd_slave_cmd_width_adapter:out_valid -> lcd_0_avalon_lcd_slave_burst_adapter:sink0_valid
	wire  [69:0] lcd_0_avalon_lcd_slave_cmd_width_adapter_src_data;                                  // lcd_0_avalon_lcd_slave_cmd_width_adapter:out_data -> lcd_0_avalon_lcd_slave_burst_adapter:sink0_data
	wire         lcd_0_avalon_lcd_slave_cmd_width_adapter_src_ready;                                 // lcd_0_avalon_lcd_slave_burst_adapter:sink0_ready -> lcd_0_avalon_lcd_slave_cmd_width_adapter:out_ready
	wire   [6:0] lcd_0_avalon_lcd_slave_cmd_width_adapter_src_channel;                               // lcd_0_avalon_lcd_slave_cmd_width_adapter:out_channel -> lcd_0_avalon_lcd_slave_burst_adapter:sink0_channel
	wire         lcd_0_avalon_lcd_slave_cmd_width_adapter_src_startofpacket;                         // lcd_0_avalon_lcd_slave_cmd_width_adapter:out_startofpacket -> lcd_0_avalon_lcd_slave_burst_adapter:sink0_startofpacket
	wire         lcd_0_avalon_lcd_slave_cmd_width_adapter_src_endofpacket;                           // lcd_0_avalon_lcd_slave_cmd_width_adapter:out_endofpacket -> lcd_0_avalon_lcd_slave_burst_adapter:sink0_endofpacket
	...
	wire         lcd_0_avalon_lcd_slave_agent_rdata_fifo_src_valid;                                  // lcd_0_avalon_lcd_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [9:0] lcd_0_avalon_lcd_slave_agent_rdata_fifo_src_data;                                   // lcd_0_avalon_lcd_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         lcd_0_avalon_lcd_slave_agent_rdata_fifo_src_ready;                                  // avalon_st_adapter_001:in_0_ready -> lcd_0_avalon_lcd_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> lcd_0_avalon_lcd_slave_agent:rdata_fifo_sink_valid
	wire   [9:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> lcd_0_avalon_lcd_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                                  // lcd_0_avalon_lcd_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> lcd_0_avalon_lcd_slave_agent:rdata_fifo_sink_error
	...
	wire         pixel_s1_agent_rdata_fifo_src_valid;                                                // pixel_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] pixel_s1_agent_rdata_fifo_src_data;                                                 // pixel_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         pixel_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_004:in_0_ready -> pixel_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> pixel_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> pixel_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // pixel_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> pixel_s1_agent:rdata_fifo_sink_error
	wire         read_address_s1_agent_rdata_fifo_src_valid;                                         // read_address_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] read_address_s1_agent_rdata_fifo_src_data;                                          // read_address_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         read_address_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_005:in_0_ready -> read_address_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> read_address_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> read_address_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // read_address_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> read_address_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) lcd_0_avalon_lcd_slave_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (lcd_0_avalon_lcd_slave_agent_m0_address),        // avalon_universal_slave_0.address
		.uav_burstcount         (lcd_0_avalon_lcd_slave_agent_m0_burstcount),     //                         .burstcount
		.uav_read               (lcd_0_avalon_lcd_slave_agent_m0_read),           //                         .read
		.uav_write              (lcd_0_avalon_lcd_slave_agent_m0_write),          //                         .write
		.uav_waitrequest        (lcd_0_avalon_lcd_slave_agent_m0_waitrequest),    //                         .waitrequest
		.uav_readdatavalid      (lcd_0_avalon_lcd_slave_agent_m0_readdatavalid),  //                         .readdatavalid
		.uav_byteenable         (lcd_0_avalon_lcd_slave_agent_m0_byteenable),     //                         .byteenable
		.uav_readdata           (lcd_0_avalon_lcd_slave_agent_m0_readdata),       //                         .readdata
		.uav_writedata          (lcd_0_avalon_lcd_slave_agent_m0_writedata),      //                         .writedata
		.uav_lock               (lcd_0_avalon_lcd_slave_agent_m0_lock),           //                         .lock
		.uav_debugaccess        (lcd_0_avalon_lcd_slave_agent_m0_debugaccess),    //                         .debugaccess
		.av_address             (lcd_0_avalon_lcd_slave_address),                 //      avalon_anti_slave_0.address
		.av_write               (lcd_0_avalon_lcd_slave_write),                   //                         .write
		.av_read                (lcd_0_avalon_lcd_slave_read),                    //                         .read
		.av_readdata            (lcd_0_avalon_lcd_slave_readdata),                //                         .readdata
		.av_writedata           (lcd_0_avalon_lcd_slave_writedata),               //                         .writedata
		.av_waitrequest         (lcd_0_avalon_lcd_slave_waitrequest),             //                         .waitrequest
		.av_chipselect          (lcd_0_avalon_lcd_slave_chipselect),              //                         .chipselect
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
		.av_byteenable          (),                                               //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (pixel_s1_agent_m0_address),                      // avalon_universal_slave_0.address
		.uav_burstcount         (pixel_s1_agent_m0_burstcount),                   //                         .burstcount
		.uav_read               (pixel_s1_agent_m0_read),                         //                         .read
		.uav_write              (pixel_s1_agent_m0_write),                        //                         .write
		.uav_waitrequest        (pixel_s1_agent_m0_waitrequest),                  //                         .waitrequest
		.uav_readdatavalid      (pixel_s1_agent_m0_readdatavalid),                //                         .readdatavalid
		.uav_byteenable         (pixel_s1_agent_m0_byteenable),                   //                         .byteenable
		.uav_readdata           (pixel_s1_agent_m0_readdata),                     //                         .readdata
		.uav_writedata          (pixel_s1_agent_m0_writedata),                    //                         .writedata
		.uav_lock               (pixel_s1_agent_m0_lock),                         //                         .lock
		.uav_debugaccess        (pixel_s1_agent_m0_debugaccess),                  //                         .debugaccess
		.av_address             (pixel_s1_address),                               //      avalon_anti_slave_0.address
		.av_readdata            (pixel_s1_readdata),                              //                         .readdata
		.av_write               (),                                               //              (terminated)
		.av_read                (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) lcd_0_avalon_lcd_slave_agent (
		.clk                     (clk_0_clk_clk),                                              //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),             //       clk_reset.reset
		.m0_address              (lcd_0_avalon_lcd_slave_agent_m0_address),                    //              m0.address
		.m0_burstcount           (lcd_0_avalon_lcd_slave_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (lcd_0_avalon_lcd_slave_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (lcd_0_avalon_lcd_slave_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (lcd_0_avalon_lcd_slave_agent_m0_lock),                       //                .lock
		.m0_readdata             (lcd_0_avalon_lcd_slave_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (lcd_0_avalon_lcd_slave_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (lcd_0_avalon_lcd_slave_agent_m0_read),                       //                .read
		.m0_waitrequest          (lcd_0_avalon_lcd_slave_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (lcd_0_avalon_lcd_slave_agent_m0_writedata),                  //                .writedata
		.m0_write                (lcd_0_avalon_lcd_slave_agent_m0_write),                      //                .write
		.rp_endofpacket          (lcd_0_avalon_lcd_slave_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (lcd_0_avalon_lcd_slave_agent_rp_ready),                      //                .ready
		.rp_valid                (lcd_0_avalon_lcd_slave_agent_rp_valid),                      //                .valid
		.rp_data                 (lcd_0_avalon_lcd_slave_agent_rp_data),                       //                .data
		.rp_startofpacket        (lcd_0_avalon_lcd_slave_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (lcd_0_avalon_lcd_slave_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (lcd_0_avalon_lcd_slave_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (lcd_0_avalon_lcd_slave_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (lcd_0_avalon_lcd_slave_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (lcd_0_avalon_lcd_slave_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (lcd_0_avalon_lcd_slave_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (lcd_0_avalon_lcd_slave_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (lcd_0_avalon_lcd_slave_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (lcd_0_avalon_lcd_slave_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (lcd_0_avalon_lcd_slave_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (lcd_0_avalon_lcd_slave_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (lcd_0_avalon_lcd_slave_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (lcd_0_avalon_lcd_slave_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (lcd_0_avalon_lcd_slave_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (lcd_0_avalon_lcd_slave_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (lcd_0_avalon_lcd_slave_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                          // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                          //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                           //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                          //                .error
		.rdata_fifo_src_ready    (lcd_0_avalon_lcd_slave_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (lcd_0_avalon_lcd_slave_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (lcd_0_avalon_lcd_slave_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                      //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                        //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) lcd_0_avalon_lcd_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                           //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),          // clk_reset.reset
		.in_data           (lcd_0_avalon_lcd_slave_agent_rf_source_data),             //        in.data
		.in_valid          (lcd_0_avalon_lcd_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (lcd_0_avalon_lcd_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (lcd_0_avalon_lcd_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (lcd_0_avalon_lcd_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (lcd_0_avalon_lcd_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (lcd_0_avalon_lcd_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (lcd_0_avalon_lcd_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (lcd_0_avalon_lcd_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (lcd_0_avalon_lcd_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                   // (terminated)
		.csr_read          (1'b0),                                                    // (terminated)
		.csr_write         (1'b0),                                                    // (terminated)
		.csr_readdata      (),                                                        // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (pixel_s1_agent_m0_address),                      //              m0.address
		.m0_burstcount           (pixel_s1_agent_m0_burstcount),                   //                .burstcount
		.m0_byteenable           (pixel_s1_agent_m0_byteenable),                   //                .byteenable
		.m0_debugaccess          (pixel_s1_agent_m0_debugaccess),                  //                .debugaccess
		.m0_lock                 (pixel_s1_agent_m0_lock),                         //                .lock
		.m0_readdata             (pixel_s1_agent_m0_readdata),                     //                .readdata
		.m0_readdatavalid        (pixel_s1_agent_m0_readdatavalid),                //                .readdatavalid
		.m0_read                 (pixel_s1_agent_m0_read),                         //                .read
		.m0_waitrequest          (pixel_s1_agent_m0_waitrequest),                  //                .waitrequest
		.m0_writedata            (pixel_s1_agent_m0_writedata),                    //                .writedata
		.m0_write                (pixel_s1_agent_m0_write),                        //                .write
		.rp_endofpacket          (pixel_s1_agent_rp_endofpacket),                  //              rp.endofpacket
		.rp_ready                (pixel_s1_agent_rp_ready),                        //                .ready
		.rp_valid                (pixel_s1_agent_rp_valid),                        //                .valid
		.rp_data                 (pixel_s1_agent_rp_data),                         //                .data
		.rp_startofpacket        (pixel_s1_agent_rp_startofpacket),                //                .startofpacket
		...
		.rf_sink_ready           (pixel_s1_agent_rsp_fifo_out_ready),              //         rf_sink.ready
		.rf_sink_valid           (pixel_s1_agent_rsp_fifo_out_valid),              //                .valid
		.rf_sink_startofpacket   (pixel_s1_agent_rsp_fifo_out_startofpacket),      //                .startofpacket
		.rf_sink_endofpacket     (pixel_s1_agent_rsp_fifo_out_endofpacket),        //                .endofpacket
		.rf_sink_data            (pixel_s1_agent_rsp_fifo_out_data),               //                .data
		.rf_source_ready         (pixel_s1_agent_rf_source_ready),                 //       rf_source.ready
		.rf_source_valid         (pixel_s1_agent_rf_source_valid),                 //                .valid
		.rf_source_startofpacket (pixel_s1_agent_rf_source_startofpacket),         //                .startofpacket
		.rf_source_endofpacket   (pixel_s1_agent_rf_source_endofpacket),           //                .endofpacket
		.rf_source_data          (pixel_s1_agent_rf_source_data),                  //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),              //                .error
		.rdata_fifo_src_ready    (pixel_s1_agent_rdata_fifo_src_ready),            //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (pixel_s1_agent_rdata_fifo_src_valid),            //                .valid
		.rdata_fifo_src_data     (pixel_s1_agent_rdata_fifo_src_data),             //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pixel_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (pixel_s1_agent_rf_source_data),                  //        in.data
		.in_valid          (pixel_s1_agent_rf_source_valid),                 //          .valid
		.in_ready          (pixel_s1_agent_rf_source_ready),                 //          .ready
		.in_startofpacket  (pixel_s1_agent_rf_source_startofpacket),         //          .startofpacket
		.in_endofpacket    (pixel_s1_agent_rf_source_endofpacket),           //          .endofpacket
		.out_data          (pixel_s1_agent_rsp_fifo_out_data),               //       out.data
		.out_valid         (pixel_s1_agent_rsp_fifo_out_valid),              //          .valid
		.out_ready         (pixel_s1_agent_rsp_fifo_out_ready),              //          .ready
		.out_startofpacket (pixel_s1_agent_rsp_fifo_out_startofpacket),      //          .startofpacket
		.out_endofpacket   (pixel_s1_agent_rsp_fifo_out_endofpacket),        //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	de2_115_camera_mm_interconnect_0_router router (
	...
	de2_115_camera_mm_interconnect_0_router_001 router_001 (
	...
	de2_115_camera_mm_interconnect_0_router_002 router_002 (
	...
	de2_115_camera_mm_interconnect_0_router_003 router_003 (
		.sink_ready         (lcd_0_avalon_lcd_slave_agent_rp_ready),          //      sink.ready
		.sink_valid         (lcd_0_avalon_lcd_slave_agent_rp_valid),          //          .valid
		.sink_data          (lcd_0_avalon_lcd_slave_agent_rp_data),           //          .data
		.sink_startofpacket (lcd_0_avalon_lcd_slave_agent_rp_startofpacket),  //          .startofpacket
		.sink_endofpacket   (lcd_0_avalon_lcd_slave_agent_rp_endofpacket),    //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_router_004 router_004 (
	...
	de2_115_camera_mm_interconnect_0_router_004 router_005 (
	...
	de2_115_camera_mm_interconnect_0_router_002 router_006 (
		.sink_ready         (pixel_s1_agent_rp_ready),                        //      sink.ready
		.sink_valid         (pixel_s1_agent_rp_valid),                        //          .valid
		.sink_data          (pixel_s1_agent_rp_data),                         //          .data
		.sink_startofpacket (pixel_s1_agent_rp_startofpacket),                //          .startofpacket
		.sink_endofpacket   (pixel_s1_agent_rp_endofpacket),                  //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_router_002 router_007 (
	...
	de2_115_camera_mm_interconnect_0_router_002 router_008 (
	...
	) lcd_0_avalon_lcd_slave_burst_adapter (
		.clk                   (clk_0_clk_clk),                                              //       cr0.clk
		.reset                 (nios2_gen2_0_reset_reset_bridge_in_reset_reset),             // cr0_reset.reset
		.sink0_valid           (lcd_0_avalon_lcd_slave_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (lcd_0_avalon_lcd_slave_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (lcd_0_avalon_lcd_slave_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (lcd_0_avalon_lcd_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (lcd_0_avalon_lcd_slave_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (lcd_0_avalon_lcd_slave_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (lcd_0_avalon_lcd_slave_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (lcd_0_avalon_lcd_slave_burst_adapter_source0_data),          //          .data
		.source0_channel       (lcd_0_avalon_lcd_slave_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (lcd_0_avalon_lcd_slave_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (lcd_0_avalon_lcd_slave_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (lcd_0_avalon_lcd_slave_burst_adapter_source0_ready)          //          .ready
	);

	de2_115_camera_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),             // clk_reset.reset
		.sink_ready         (lcd_0_avalon_lcd_slave_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (lcd_0_avalon_lcd_slave_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (lcd_0_avalon_lcd_slave_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (lcd_0_avalon_lcd_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (lcd_0_avalon_lcd_slave_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (lcd_0_avalon_lcd_slave_rsp_width_adapter_src_valid),         //          .valid
	...
	de2_115_camera_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	de2_115_camera_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (lcd_0_avalon_lcd_slave_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (lcd_0_avalon_lcd_slave_rsp_width_adapter_src_data),          //          .data
		.out_channel          (lcd_0_avalon_lcd_slave_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (lcd_0_avalon_lcd_slave_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (lcd_0_avalon_lcd_slave_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (lcd_0_avalon_lcd_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) lcd_0_avalon_lcd_slave_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                              //       clk.clk
		.reset                (nios2_gen2_0_reset_reset_bridge_in_reset_reset),             // clk_reset.reset
		...
		.out_endofpacket      (lcd_0_avalon_lcd_slave_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (lcd_0_avalon_lcd_slave_cmd_width_adapter_src_data),          //          .data
		.out_channel          (lcd_0_avalon_lcd_slave_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (lcd_0_avalon_lcd_slave_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (lcd_0_avalon_lcd_slave_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (lcd_0_avalon_lcd_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                      // (terminated)
	);

	de2_115_camera_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	de2_115_camera_mm_interconnect_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (10),
		.inUsePackets    (0),
		.inDataWidth     (10),
		.inChannelWidth  (0),
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                     // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset),    // in_rst_0.reset
		.in_0_data      (lcd_0_avalon_lcd_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (lcd_0_avalon_lcd_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (lcd_0_avalon_lcd_slave_agent_rdata_fifo_src_ready), //         .ready
	...
	de2_115_camera_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (pixel_s1_agent_rdata_fifo_src_data),             //     in_0.data
		.in_0_valid     (pixel_s1_agent_rdata_fifo_src_valid),            //         .valid
		.in_0_ready     (pixel_s1_agent_rdata_fifo_src_ready),            //         .ready
